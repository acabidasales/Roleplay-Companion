        ...
        <ul className="navbar-nav flex w-full">
            <Link id="0" href="/" className="nav-item active relative group flex">
                ...
                <div className='w-full h-full flex justify-center items-center'>
                    <p className={"inline-block align-middle lg:text-lg md:text-md sm:text-sm group-hover:text-sky-600 " + (url === "/" ? "text-sky-600" : "text-white")}>Inicio</p>
                </div>
                </div>
            ...
            <Link id="1" href="/personajes" className="nav-item relative group flex">
                <div className="nav-link my-4 lg:mx-4 md:mx-2 sm:mx-2">
                <div className='w-full h-full flex justify-center items-center'>
                    <p className={"inline-block align-middle lg:text-lg md:text-md sm:text-sm group-hover:text-sky-600 " + (url.startsWith("/personajes") ? "text-sky-600" : "text-white")}>Mis personajes</p>
                </div>
                </div>
            ...
            <Link id="2" href="/campañas" className="nav-item relative group flex">
                <div className="nav-link my-4 lg:mx-4 md:mx-2 sm:mx-2">
                <div className='w-full h-full flex justify-center items-center'>
                    <p className={"inline-block align-middle lg:text-lg md:text-md sm:text-sm group-hover:text-sky-600 " + (url.startsWith("/campañas") ? "text-sky-600" : "text-white")}>Campañas</p>
                </div>
                </div>
                <span className={"absolute bottom-0 left-1/2 w-0 h-1 bg-sky-600 " + (url.startsWith("/campañas") ? "w-1/2 transition-all" : "group-hover:w-1/2 group-hover:transition-all")}></span>
                <span className={"absolute bottom-0 right-1/2 w-0 h-1 bg-sky-600 " + (url.startsWith("/campañas") ? "w-1/2 transition-all" : "group-hover:w-1/2 group-hover:transition-all")}></span>
            </Link>
            <Link id="3" href="/wiki" className="nav-item relative group flex">
                <div className="nav-link my-4 lg:mx-4 md:mx-2 sm:mx-2">
                <div className='w-full h-full flex justify-center items-center'>
                    <p className={"inline-block align-middle lg:text-lg md:text-md sm:text-sm group-hover:text-sky-600 " + (url.startsWith("/wiki") ? "text-sky-600" : "text-white")}>Wiki</p>
                </div>
                </div>
