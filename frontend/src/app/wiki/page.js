    ...
    return (
        <div className='lg:max-w-screen-2xl md:max-w-screen-md sm:max-w-screen-sm transition-all mx-auto bg-zinc-800 rounded pl-3 pr-3 pb-3 z-0'>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-8 p-4'>
                <a href="/wiki/alineamientos" className="block max-w-scre p-6 bg-zinc-800 border border-zinc-900 rounded-lg shadow hover:bg-sky-400 hover:bg-opacity-10 transition-all">
                ...
                <a href="/wiki/clases" className="block max-w-scre p-6 bg-zinc-800 border border-zinc-900 rounded-lg shadow hover:bg-sky-400 hover:bg-opacity-10 transition-all">
                ...
                <a href="/wiki/equipamiento" className="block max-w-scre p-6 bg-zinc-800 border border-zinc-900 rounded-lg shadow hover:bg-sky-400 hover:bg-opacity-10 transition-all">
                ...
                <a href="/wiki/habilidades" className="block max-w-scre p-6 bg-zinc-800 border border-zinc-900 rounded-lg shadow hover:bg-sky-400 hover:bg-opacity-10 transition-all">
                ...
                <a href="/wiki/razas" className="block max-w-scre p-6 bg-zinc-800 border border-zinc-900 rounded-lg shadow hover:bg-sky-400 hover:bg-opacity-10 transition-all">
                ...
                <a href="/wiki/transfondos" className="block max-w-scre p-6 bg-zinc-800 border border-zinc-900 rounded-lg shadow hover:bg-sky-400 hover:bg-opacity-10 transition-all">
