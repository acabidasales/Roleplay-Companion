    ...
    return (
        <div className='lg:max-w-screen-2xl md:max-w-screen-md sm:max-w-screen-sm transition-all mx-auto bg-bg-950 mt-4 p-6 rounded-3xl z-0'>
            ...
            <div className="relative items-center bg-bg-950 rounded-lg shadow transition-all">
                <Image width={1000} height={1000} className="object-cover rounded-2xl md:h-auto md:rounded-s-lg p-1 mx-auto" src={"/campañas/" + data_campañas.imagen} alt="Imagen campaña" />
                <div className="p-4 text-center w-full">
                    <h5 className="mb-2 text-lg font-semibold tracking-tight text-white">{data_campañas.descripcion}</h5>
                </div>
            </div>
